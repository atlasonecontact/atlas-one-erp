...
import { X, Flashlight, FlashlightOff, Camera, SwitchCamera, Zap } from "lucide-react"
...
export function CameraScanner({ isOpen, onClose, onScan }: CameraScannerProps) {
  ...
  const startBarcodeDetection = useCallback(() => {
    if (!window.BarcodeDetector) {
      ...
      console.log("[v0] BarcodeDetector not supported, using manual input")
      return
    }
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black flex flex-col">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 safe-area-bottom bg-gradient-to-t from-black/80 to-transparent">
        <p className="text-center text-white text-sm mb-4">Apuntá al código de barras para escanearlo</p>
